...
public class Config {
	 ...
	 * 存放图片地址
	 */
	public static final String PHOTO_FOLDER =
		new File(Environment.getExternalStorageDirectory(), "").getPath() + "/drizzledaily/pics";

	public static final String START_PHOTO_FOLDER =
		new File(Environment.getExternalStorageDirectory(), "").getPath() + "/drizzledaily/start";
	/**
	 ...
	 * 头像地址
	 */
	public static final String TOUXIANGURL =
		"http://d.hiphotos.baidu.com/baike/w%3D268/sign=f456853874cf3bc7e800caeae900babd/962bd40735fae6cde8d6d2540bb30f2442a70fa0.jpg";
}
